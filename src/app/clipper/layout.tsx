...
export default function ClipperLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#070A0F] text-slate-100 flex flex-col md:flex-row relative">
      ...
      {/* Floating "Need help?" Button in White cleanly docked bottom-right */}
      <div className="fixed bottom-6 right-6 z-50">
        <button
          onClick={() => setHelpOpen(true)}
          aria-label="Open help and support dialog"
          className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-white hover:bg-slate-100 text-slate-950 font-bold text-xs sm:text-sm shadow-xl shadow-white/10 transition-all hover:scale-105 active:scale-95"
        >
