            ...
            <div className="mt-2.5 space-y-1.5">
              ...
              {(user?.role === "MANAGER" || user?.role === "ADMIN") && (
                <Link
                  ...
                  className="flex items-center justify-between px-3 py-2 rounded-xl text-xs font-semibold text-purple-400 hover:bg-purple-950/30 border border-purple-800/30 transition-all mt-2"
                >
              ...
              {user?.role === "ADMIN" && (
                <Link
                  ...
                  className="flex items-center justify-between px-3 py-2 rounded-xl text-xs font-semibold text-red-400 hover:bg-red-950/30 border border-red-800/30 transition-all mt-1"
                >
                  <div className="flex items-center gap-2.5">
